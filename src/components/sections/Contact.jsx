        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-slate-300 text-lg mb-8">
              Have questions about Zenith? Our team is here to help.
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-indigo-300">support@zenithapp.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-indigo-300">123 Innovation Way, Tech City, CA 94103</p>
                </div>
              </div>
            </div>
