  ...
  return (
    <div className="space-y-4">
      {repositories.map((repo) => (
        <Card key={repo.id} className="border border-slate-200 hover:border-indigo-200 transition-colors">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <div className="flex items-center">
                    <h3 className="text-lg font-medium text-slate-900">{repo.name}</h3>
                    <div className="ml-2">
